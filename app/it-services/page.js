export const metadata = {
  title: "IT-Services | The German Guy",
  description:
    "Professional IT-Services by The German Guy — secure systems, scalable software, modern websites, and smart digital solutions.",
};
...
const otherProducts = [
  {
    name: "Leadhaus",
    detail:
      "Our custom CRM built specifically for Educational Consultancies to make student tracking and data management simpler and more efficient.",
    href: "https://leadhaus.thegermanguy.org",
  },
  {
    name: "Grade Conversion",
    detail:
      "A tool to convert grades earned in countries other than Germany using the modified Bavarian formula. The result is a first orientation and is not binding.",
...
export default function ITServicesPage() {
  return (
    <main className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-300">
      ...
      <section id="brand-new-product" className="bg-white dark:bg-slate-950 py-20 md:py-28 overflow-hidden relative transition-colors duration-300">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-7xl mx-auto">
            ...
            <div id="portfolio" className="mt-20 md:mt-28 border-t border-slate-200 dark:border-slate-800 pt-16 md:pt-20">
              <div className="text-center mb-12">
                <h3 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white transition-colors duration-300">
                  Projects & products
                </h3>
              </div>
...
function PortfolioCard({ project }) {
  ...
  return (
    <div className="h-full p-8 bg-white dark:bg-slate-900 rounded-2xl shadow-md border border-slate-100 dark:border-slate-800 transition-colors duration-300">
      <h4 className="text-2xl font-bold text-slate-900 dark:text-white transition-colors duration-300">
        {project.href ? (
          <a
            href={project.href}
